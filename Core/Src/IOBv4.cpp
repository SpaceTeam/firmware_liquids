...
IOBv4::IOBv4(uint32_t node_id, uint32_t fw_version, uint32_t refresh_divider) :
	...
	//channel2(2,{ ADC2, STRHAL_ADC_CHANNEL_13 },		{ GPIOA, 10, STRHAL_GPIO_TYPE_OPP }, STRHAL_ADC_INTYPE_REGULAR, 1),
		...
		tempext(
				...
				STRHAL_SPI_SPI4,
				{ STRHAL_SPI_SPI4_SCK_PE12,  STRHAL_SPI_SPI4_MISO_PE13, STRHAL_SPI_SPI4_MOSI_PE14, STRHAL_SPI_SPI4_NSS_PE11, STRHAL_SPI_MODE_MASTER, STRHAL_SPI_CPOL_CPHASE_HH, 5}
		)
{
