...
PMU::PMU(uint32_t node_id, uint32_t fw_version, uint32_t refresh_divider) :
	...
	sense_5VP(1, {ADC2, STRHAL_ADC_CHANNEL_9}, 1),
	...
	out0(5, {NULL}, {GPIOC, 6, STRHAL_GPIO_TYPE_OPP}, 1),//TODO Handle NULL Feedback
	out1(6, {NULL}, {GPIOC, 7, STRHAL_GPIO_TYPE_OPP}, 1),//TODO Handle NULL Feedback
	out2(7, {NULL}, {GPIOC, 8, STRHAL_GPIO_TYPE_OPP}, 1),//TODO Handle NULL Feedback
	out3(8, {NULL}, {GPIOC, 9, STRHAL_GPIO_TYPE_OPP}, 1),//TODO Handle NULL Feedback
	payload(9, {NULL}, {GPIOC, 1, STRHAL_GPIO_TYPE_OPP}, 1),//TODO Handle NULL Feedback
