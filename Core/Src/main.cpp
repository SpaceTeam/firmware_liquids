...
const ChannelLookUpEntry channellookUp[]=
{
		...
		[DEVICE_ID_GSE_PNEU_0_PRESSURANT_TANKING_VALVE			] = { NODE_ID_LAMARR_GSE_PNEU_0,		ECU_LAMARR_IGNITER0},
		[DEVICE_ID_GSE_PNEU_0_PRESSURANT_VENT_VALVE				] = { NODE_ID_LAMARR_GSE_PNEU_0,		ECU_LAMARR_IGNITER1},
		[DEVICE_ID_GSE_PNEU_0_OX_TANKING_VALVE					] = { NODE_ID_LAMARR_GSE_PNEU_0,		ECU_LAMARR_IGNITER2},
		[DEVICE_ID_GSE_PNEU_0_PRESSURANT_TANKING_VALVE_FEEDBACK	] = { NODE_ID_LAMARR_GSE_PNEU_0,		ECU_LAMARR_PRESS0},
		[DEVICE_ID_GSE_PNEU_0_PRESSURANT_VENT_VALVE_FEEDBACK	] = { NODE_ID_LAMARR_GSE_PNEU_0,		ECU_LAMARR_PRESS1},
		[DEVICE_ID_GSE_PNEU_0_OX_TANKING_VALVE_FEEDBACK			] = { NODE_ID_LAMARR_GSE_PNEU_0,		ECU_LAMARR_PRESS2},
		[DEVICE_ID_GSE_PNEU_0_DEWAR_PRESS_VALVE					] = { NODE_ID_LAMARR_GSE_PNEU_0,		ECU_LAMARR_IGNITER3},
		[DEVICE_ID_GSE_PNEU_1_PNEU_PRESS_IN						] = { NODE_ID_LAMARR_GSE_PNEU_1,		ECU_LAMARR_PRESS0},
		[DEVICE_ID_GSE_PNEU_1_DEWAR_PRESSURE					] = { NODE_ID_LAMARR_GSE_PNEU_1,		ECU_LAMARR_PRESS1},
		[DEVICE_ID_GSE_PNEU_1_VENTILINSEL_PRESSURE				] = { NODE_ID_LAMARR_GSE_PNEU_1,		ECU_LAMARR_PRESS2},
		[DEVICE_ID_GSE_PNEU_1_HOLDDOWN							] = { NODE_ID_LAMARR_GSE_PNEU_1,		ECU_LAMARR_IGNITER0},
		[DEVICE_ID_GSE_PNEU_1_OX_DECOUPLER_FEEDBACK				] = { NODE_ID_LAMARR_GSE_PNEU_1,		ECU_LAMARR_IGNITER1},
		[DEVICE_ID_GSE_ELEC_IOB_OX_DECOUPLER					] = { NODE_ID_LAMARR_GSE_ELEC_IOB0,		ECU_LAMARR_IGNITER0},		//12V
		[DEVICE_ID_GSE_ELEC_IOB_STRONGBACK						] = { NODE_ID_LAMARR_GSE_ELEC_IOB0,		ECU_LAMARR_IGNITER1},		//12V
		[DEVICE_ID_GSE_ELEC_IOB_EXTERNAL_IGNITER				] = { NODE_ID_LAMARR_GSE_ELEC_IOB0,		ECU_LAMARR_IGNITER3},		//12V
		[DEVICE_ID_GSE_ELEC_BOB_LAMP_RED						] = { NODE_ID_LAMARR_GSE_ELEC_BOB,		ECU_LAMARR_IGNITER0},		//12V
		[DEVICE_ID_GSE_ELEC_BOB_LAMP_GREEN						] = { NODE_ID_LAMARR_GSE_ELEC_BOB,		ECU_LAMARR_IGNITER1},		//24V RBF
		...
		[DEVICE_ID_RCU_GENERIC_CHANNEL							] = { NODE_ID_LAMARR_RCU_V2,			GENERIC_CHANNEL_ID}
