...
const ChannelLookUpEntry channellookUp[]=
{
		...
		[DEVICE_ID_GSE_ELEC_IOB_OX_DECOUPLER					] = { NODE_ID_LAMARR_GSE_ELEC_IOB,		ECU_LAMARR_IGNITER0},		//12V
		[DEVICE_ID_GSE_ELEC_IOB_STRONGBACK						] = { NODE_ID_LAMARR_GSE_ELEC_IOB,		ECU_LAMARR_IGNITER1},		//12V
		[DEVICE_ID_GSE_ELEC_IOB_EXTERNAL_IGNITER				] = { NODE_ID_LAMARR_GSE_ELEC_IOB,		ECU_LAMARR_IGNITER3},		//12V
